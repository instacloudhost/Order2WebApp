...
class ItemCategoryController extends Controller
{
    ...
    public function __construct(CategoryItemRepository $categoryRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo)
    {
        parent::__construct();
     ...
     * @return Response
     */
    public function index(ItemCategoryDataTable $categoryDataTable)
    {
        return $categoryDataTable->render('itemcategories.index');
    }
    ...
    public function create()
    {
        ...
        return view('itemcategories.create')->with("customFields", isset($html) ? $html : false);
    }
    ...
    public function show($id)
    {
        ...
        return view('itemcategories.show')->with('category', $category);
    }
    ...
    public function edit($id)
    {
        ...
        return view('itemcategories.edit')->with('category', $category)->with("customFields", isset($html) ? $html : false);
    }
