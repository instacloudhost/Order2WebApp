...
<div class="form-group row ">
  {!! Form::label('itemcategory_id', trans("lang.items_input_name"),['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('itemcategory_id', $categoryItem, null, ['class' => 'select2 form-control']) !!}
    <div class="form-text text-muted">{{ trans("lang.items_input_hint") }}</div>
  </div>
</div>
